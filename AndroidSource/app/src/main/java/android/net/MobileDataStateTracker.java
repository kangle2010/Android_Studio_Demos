...
public class MobileDataStateTracker extends BaseNetworkStateTracker {
     ...
     */
    private void setDetailedState(DetailedState state, String reason,
            String extraInfo) {
        ...
        if (state != mNetworkInfo.getDetailedState()) {
             ...
             */
            if (wasConnecting && state == DetailedState.CONNECTED && reason == null
                    && lastReason != null)
                reason = lastReason;
...
//            }
    ...
    /**
     * @see NetworkStateTracker#getLinkProperties()
     */
    @Override
