 ...
 * <ul>
 * <li>Declares the {@link Manifest.permission#SCORE_NETWORKS} permission.
 * <li>Includes a receiver for {@link #ACTION_SCORE_NETWORKS} guarded by the
 *     {@link Manifest.permission#BROADCAST_SCORE_NETWORKS} permission which scores networks
...
public class NetworkScoreManager {
     ...
     * {@link Intent#getParcelableArrayExtra(String)}}.
     */
     ...
     *         {@link Manifest.permission#BROADCAST_SCORE_NETWORKS} permission indicating
     ...
     * @throws SecurityException if the caller does not hold the
     *         {@link Manifest.permission#BROADCAST_SCORE_NETWORKS} permission.
     * @hide
     */
