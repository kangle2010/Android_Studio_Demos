...
public class ProgressBar extends View {
     ...
     * current tint mode, which is {@link Mode#SRC_IN} by default.
     * <p>
     ...
     *         drawable
     * @attr ref android.R.styleable#ProgressBar_indeterminateTintMode
     * @see #setIndeterminateTintMode(Mode)
     */
    @Nullable
     ...
     * mode, which is {@link Mode#SRC_IN} by default.
     * <p>
     ...
     * indicator. The default mode is {@link Mode#SRC_IN}.
     *
     * @param tintMode the blending mode used to apply the tint, may be
     *                 {@code null} to clear tint
     ...
     * background. The default mode is {@link Mode#SRC_IN}.
     *
     * @param tintMode the blending mode used to apply the tint, may be
     *                 {@code null} to clear tint
     ...
     *         background
     * @attr ref android.R.styleable#ProgressBar_progressBackgroundTintMode
     * @see #setProgressBackgroundTintMode(Mode)
     */
    @Nullable
     ...
     *         progress drawable
     * @attr ref android.R.styleable#ProgressBar_secondaryProgressTintMode
     * @see #setSecondaryProgressTintMode(Mode)
     */
    @Nullable
