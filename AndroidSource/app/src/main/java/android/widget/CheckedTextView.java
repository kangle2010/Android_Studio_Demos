...
/**
 * An extension to TextView that supports the {@link Checkable} interface.
 * This is useful when used in a {@link ListView ListView} where the it's
 * {@link ListView#setChoiceMode(int) setChoiceMode} has been set to
 * something other than {@link ListView#CHOICE_MODE_NONE CHOICE_MODE_NONE}.
 *
