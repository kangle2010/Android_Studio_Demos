...
public abstract class SensorManager {
    ...
    /**
     * Registers a {@link SensorEventListener
     ...
     *
     * @param listener
     *        A {@link SensorEventListener SensorEventListener}
     *        object.
     *
     * @param sensor
     *        The {@link Sensor Sensor} to register to.
     *
     * @param rateUs
     *        The rate {@link SensorEvent sensor events} are
     ...
     *
     * @param handler
     *        The {@link Handler Handler} the
     *        {@link SensorEvent sensor events} will be
     *        delivered to.
     *
     ...
     *            continuous mode as soon as they are available which is equivalent to calling
     *            {@link #registerListener(SensorEventListener, Sensor, int)}.
     * @param handler The {@link Handler Handler} the
     *        {@link SensorEvent sensor events} will be delivered to.
     *
     * @return <code>true</code> if batch mode is successfully enabled for this sensor,
     *         <code>false</code> otherwise.
