...
public class Notification implements Parcelable
{
     ...
     * example, before {@link Build.VERSION_CODES#HONEYCOMB}, this number was
     * superimposed over the icon in the status bar. Starting with
     * {@link Build.VERSION_CODES#HONEYCOMB}, the template used by
     * {@link Builder} has displayed the number in the expanded notification view.
     *
     ...
     * {@link Builder#addAction(int, CharSequence, PendingIntent) addAction} will be
