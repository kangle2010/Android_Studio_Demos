...
public abstract class SharedElementCallback {
     ...
     *     {@link #onSharedElementStart(List, List, List)}
     ...
     *     be affected by layout and if changed in {@link #onSharedElementStart(List,
     *     List, List)}, it will also have to be set here again to correct
     *     the end state.
     * </p>
     *
     * @param sharedElementNames The names of the shared elements that were accepted into
