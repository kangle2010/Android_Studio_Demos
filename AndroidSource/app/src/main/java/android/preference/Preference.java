...
public class Preference implements Comparable<Preference> {
    ...
    /**
     * Attempts to persist a String to the {@link SharedPreferences}.
     * <p>
    ...
    /**
     * Attempts to get a persisted String from the {@link SharedPreferences}.
     * <p>
    ...
    /**
     * Attempts to persist an int to the {@link SharedPreferences}.
     * 
     * @param value The value to persist.
     * @return True if the Preference is persistent. (This is not whether the
     *         value was persisted, since we may not necessarily commit if there
    ...
    /**
     * Attempts to get a persisted int from the {@link SharedPreferences}.
     * 
    ...
    /**
     * Attempts to persist a float to the {@link SharedPreferences}.
     * 
     * @param value The value to persist.
    ...
    /**
     * Attempts to get a persisted float from the {@link SharedPreferences}.
     * 
     * @param defaultReturnValue The default value to return if either this
     *            Preference is not persistent or this Preference is not in the
     *            SharedPreferences.
    ...
    /**
     * Attempts to persist a long to the {@link SharedPreferences}.
     * 
     * @param value The value to persist.
     * @return True if this Preference is persistent. (This is not whether the
     *         value was persisted, since we may not necessarily commit if there
    ...
    /**
     * Attempts to get a persisted long from the {@link SharedPreferences}.
     * 
     * @param defaultReturnValue The default value to return if either this
     *            Preference is not persistent or this Preference is not in the
     *            SharedPreferences.
    ...
    /**
     * Attempts to persist a boolean to the {@link SharedPreferences}.
     * 
     * @param value The value to persist.
     * @return True if this Preference is persistent. (This is not whether the
     *         value was persisted, since we may not necessarily commit if there
    ...
    /**
     * Attempts to get a persisted boolean from the {@link SharedPreferences}.
     * 
     * @param defaultReturnValue The default value to return if either this
     *            Preference is not persistent or this Preference is not in the
     *            SharedPreferences.
